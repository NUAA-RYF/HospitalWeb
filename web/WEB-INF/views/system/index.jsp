...
<div class="app-container">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="panel panel-default dropdown">
                            ...
                            <div id="dropdown-table" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <ul class="nav navbar-nav">
                                        <li><a href="${pageContext.request.contextPath}/admin/system/clientUserList">Client User Table</a>
                                        </li>
                                        <li><a>Datatable</a>
                                        </li>
                                    </ul>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="thumbnail no-margin-bottom">
                                    <img src="resources/admin/bootstrap/img/thumbnails/picjumbo.com_IMG_4566.jpg"
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="thumbnail no-margin-bottom">
                                    <img src="resources/admin/bootstrap/img/thumbnails/picjumbo.com_IMG_3241.jpg"
                                         class="img-responsive" alt="">
                                    <div class="caption">
                        ...
                        <div class="card card-success">
                            ...
                            <div class="card-body no-padding">
                                <ul class="message-list">
                                    <a href="#">
                                        <li>
                                            <img src="resources/admin/bootstrap/img/profile/profile-1.jpg"
                                                 class="profile-img pull-left" alt="">
    ...
    <footer class="app-footer">
        <div class="wrapper">
            <span class="pull-right">2.1 <a href="#"><i class="fa fa-long-arrow-up"></i></a></span> &copy; 2019
